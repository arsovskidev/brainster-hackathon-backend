            ...
            <div class="w-full md:w-1/3 md:max-w-none bg-white px-8 md:px-10 py-8 md:py-10 mb-3 mx-auto md:my-6 rounded-md shadow-lg shadow-gray-600 md:flex md:flex-col h-full">
                <div class="w-full flex-grow">
                    ...
                    <div class="rounded-lg shadow-lg shadow-gray-600 bg-yellow-400 my-5 border-4 border-gray-300 border-opacity-45">
                        <div class=" p-2">
                            <p class="text-center mb-2 text-xl text-gray-700"><span class="font-bold">From:</span> {{$message->first_name . " " . $message->last_name}} </p>
                        </div>
                        <div class="p-2 border-t-4 border-gray-300 border-opacity-45">
                            <p class="text-center mb-2 text-gray-700"><span class="font-bold">Email:</span> {{$message->email}}</p>
                            <p class="text-center mb-2 text-gray-700"><span class="font-bold">Phone:</span> +389 {{$message->phone}}</p>
                        </div>
                        <div class="p-2 border-t-4 border-gray-300 border-opacity-45">
            ...
            <div class="w-full md:w-1/3 md:max-w-none bg-white px-8 md:px-10 py-8 md:py-10 mb-3 mx-auto md:my-6 rounded-md shadow-lg shadow-gray-600 md:flex md:flex-col h-full">
                <div class="w-full flex-grow">
                    ...
                    <div class="rounded-lg shadow-lg shadow-gray-600 bg-yellow-400 my-5 border-4 border-gray-300 border-opacity-45">
                        ...
                        <button class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center mb-2">
